...
public class CartaoService {
    ...
    @Transactional
    public void atualizaSaldo(Integer numeroCartao, Integer codigoSeguranca, BigDecimal valorCompra) {
        repository.atualizaSaldo(numeroCartao, codigoSeguranca, valorCompra);
    }

    public boolean isSaldoSuficiente(Integer numeroCartao, Integer codigoSeguranca, BigDecimal valorCompra) {
        Cartao cartao = getCartao(numeroCartao, codigoSeguranca);
        return cartao.getValorCredito().compareTo(valorCompra) >= 0;
    }
